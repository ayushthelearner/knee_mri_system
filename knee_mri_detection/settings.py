"""
Django settings for knee_mri_detection project.
...
SECRET_KEY = "django-insecure-m96y^(&q4p7)wdp5crm%q%58_%)^q#i-(8!fl4bzoqocbu=u+n"
...
ROOT_URLCONF = "knee_mri_detection.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'),  # This tells Django to look in the main project's templates folder
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "knee_mri_detection.wsgi.application"
